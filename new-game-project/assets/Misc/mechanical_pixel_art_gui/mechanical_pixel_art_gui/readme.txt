...
Hello! Thank you for downloading the Mechanical Pixel Art GUI. Here are a few pointers to help you navigate and make sense of this zip file.
...
Special note for Mechanical GUI:
This GUI has parts that not only stretch, but *repeat* as well. When using the nine-slices, please adjust your texture UV to repeat the textures properly!
