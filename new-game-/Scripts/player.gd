...
@onready var health_bar = %PlayerUI/TextureProgressBar # Reference to UI health bar
...
func _physics_process(delta):
	...
	update_facing_direction() # Update sprite flip based on horizontal velocity
#endregion
...
func apply_movement(delta):
	...
	if is_on_floor() and current_state in [States.JUMP, States.DOUBLE_JUMP, States.FALLING, States.AIR_ATTACK_1, States.AIR_ATTACK_2, States.AIR_ATTACK_3]:
		current_state = States.IDLE
